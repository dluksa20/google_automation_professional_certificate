...
def process_data(data):
  ...
  for item in data:
    ...
    if year in max_year:
      ...
      max_year[year]=sales
  res = max(max_year, key=max_year.get)

  summary = [
    "The {} generated the most revenue: ${}".format(format_car(max_revenue["car"]), max_revenue["revenue"]),
    "The {} had the most sales: {}".format(format_car(max_sales["car"]), max_sales["total_sales"]),
    "The most popular year was {} with {} sales".format(res, max_year[res]),
  ]
...
def main(argv):
    ...
    msg = email_generate("automation@example.com", "student@example.com", "Sales summary for last month", new_summary, "/tmp/cars.pdf")
    email_send(msg)
